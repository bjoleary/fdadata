...
#' 34706 to 32411, a reduction of 2295 or approximately 7%.
#'
#' \code{company_group} has
#' 31361 unique company names -- 1050 less that \code{company_clean} (roughly a
#' 3% reduction) and 3345 less than \code{sponsor} -- for a total reduction of
#' about 10%.
#'
#' @format A tibble with 231792 rows and 30 fields:
#'
#' \describe{
