...
#' 34551 to 32284, a reduction of 2267 or approximately 7%.
#'
#' \code{company_group} has
#' 31238 unique company names -- 1046 less that \code{company_clean} (roughly a
#' 3% reduction) and 3313 less than \code{sponsor} -- for a total reduction of
#' about 10%.
#'
#' @format A tibble with 230627 rows and 30 fields:
#'
#' \describe{
