...
#' 34689 to 32395, a reduction of 2294 or approximately 7%.
#'
#' \code{company_group} has
#' 31345 unique company names -- 1050 less that \code{company_clean} (roughly a
#' 3% reduction) and 3344 less than \code{sponsor} -- for a total reduction of
#' about 10%.
#'
#' @format A tibble with 231657 rows and 30 fields:
#'
#' \describe{
