...
#' 34661 to 32372, a reduction of 2289 or approximately 7%.
#'
#' \code{company_group} has
#' 31323 unique company names -- 1049 less that \code{company_clean} (roughly a
#' 3% reduction) and 3338 less than \code{sponsor} -- for a total reduction of
#' about 10%.
#'
#' @format A tibble with 231414 rows and 30 fields:
#'
#' \describe{
