...
#' 38813 to 31801, a reduction of 7012 or approximately 18%.
#'
#' \code{company_group} has
#' 30761 unique company names -- 1040 less that \code{company_clean} (roughly a
#' 3% reduction) and 8052 less than \code{sponsor} -- for a total reduction of
#' about 21%.
#'
#' @format A tibble with 223276 rows and 30 fields:
#'
#' \describe{
