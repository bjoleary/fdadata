...
#' 35003 to 29353, a reduction of 5650 or approximately 16%.
#'
#' \code{company_group} has
#' 28387 unique company names -- 966 less that \code{company_clean} (roughly a
#' 3% reduction) and 6616 less than \code{sponsor} -- for a total reduction of
#' about 19%.
#'
#' @format A tibble with 206268 rows and 30 fields:
#'
#' \describe{
