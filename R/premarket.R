...
#' 39076 to 31978, a reduction of 7098 or approximately 18%.
#'
#' \code{company_group} has
#' 30930 unique company names -- 1048 less that \code{company_clean} (roughly a
#' 3% reduction) and 8146 less than \code{sponsor} -- for a total reduction of
#' about 21%.
#'
#' @format A tibble with 224524 rows and 30 fields:
#'
#' \describe{
