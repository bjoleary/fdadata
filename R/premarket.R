...
#' 34732 to 32434, a reduction of 2298 or approximately 7%.
#'
#' \code{company_group} has
#' 31383 unique company names -- 1051 less that \code{company_clean} (roughly a
#' 3% reduction) and 3349 less than \code{sponsor} -- for a total reduction of
#' about 10%.
#'
#' @format A tibble with 231906 rows and 30 fields:
#'
#' \describe{
