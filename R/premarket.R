...
#' 34755 to 32454, a reduction of 2301 or approximately 7%.
#'
#' \code{company_group} has
#' 31403 unique company names -- 1051 less that \code{company_clean} (roughly a
#' 3% reduction) and 3352 less than \code{sponsor} -- for a total reduction of
#' about 10%.
#'
#' @format A tibble with 232020 rows and 30 fields:
#'
#' \describe{
