...
#' 34675 to 32383, a reduction of 2292 or approximately 7%.
#'
#' \code{company_group} has
#' 31334 unique company names -- 1049 less that \code{company_clean} (roughly a
#' 3% reduction) and 3341 less than \code{sponsor} -- for a total reduction of
#' about 10%.
#'
#' @format A tibble with 231531 rows and 30 fields:
#'
#' \describe{
