...
#' 34813 to 32501, a reduction of 2312 or approximately 7%.
#'
#' \code{company_group} has
#' 31449 unique company names -- 1052 less that \code{company_clean} (roughly a
#' 3% reduction) and 3364 less than \code{sponsor} -- for a total reduction of
#' about 10%.
#'
#' @format A tibble with 232324 rows and 30 fields:
#'
#' \describe{
