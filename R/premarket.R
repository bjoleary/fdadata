...
#' 34581 to 32310, a reduction of 2271 or approximately 7%.
#'
#' \code{company_group} has
#' 31264 unique company names -- 1046 less that \code{company_clean} (roughly a
#' 3% reduction) and 3317 less than \code{sponsor} -- for a total reduction of
#' about 10%.
#'
#' @format A tibble with 230852 rows and 30 fields:
#'
#' \describe{
