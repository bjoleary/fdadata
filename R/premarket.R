...
#' 34465 to 32208, a reduction of 2257 or approximately 7%.
#'
#' \code{company_group} has
#' 31160 unique company names -- 1048 less that \code{company_clean} (roughly a
#' 3% reduction) and 3305 less than \code{sponsor} -- for a total reduction of
#' about 10%.
#'
#' @format A tibble with 229912 rows and 30 fields:
#'
#' \describe{
