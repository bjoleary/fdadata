...
#' 34562 to 32294, a reduction of 2268 or approximately 7%.
#'
#' \code{company_group} has
#' 31248 unique company names -- 1046 less that \code{company_clean} (roughly a
#' 3% reduction) and 3314 less than \code{sponsor} -- for a total reduction of
#' about 10%.
#'
#' @format A tibble with 230728 rows and 30 fields:
#'
#' \describe{
