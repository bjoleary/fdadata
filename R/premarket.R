...
#' 39020 to 31941, a reduction of 7079 or approximately 18%.
#'
#' \code{company_group} has
#' 30895 unique company names -- 1046 less that \code{company_clean} (roughly a
#' 3% reduction) and 8125 less than \code{sponsor} -- for a total reduction of
#' about 21%.
#'
#' @format A tibble with 224235 rows and 30 fields:
#'
#' \describe{
