...
#' 38951 to 31889, a reduction of 7062 or approximately 18%.
#'
#' \code{company_group} has
#' 30846 unique company names -- 1043 less that \code{company_clean} (roughly a
#' 3% reduction) and 8105 less than \code{sponsor} -- for a total reduction of
#' about 21%.
#'
#' @format A tibble with 223939 rows and 30 fields:
#'
#' \describe{
