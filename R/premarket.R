...
#' 39755 to 32414, a reduction of 7341 or approximately 18%.
#'
#' \code{company_group} has
#' 31351 unique company names -- 1063 less that \code{company_clean} (roughly a
#' 3% reduction) and 8404 less than \code{sponsor} -- for a total reduction of
#' about 21%.
#'
#' @format A tibble with 227979 rows and 30 fields:
#'
#' \describe{
