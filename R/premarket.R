...
#' 39223 to 32068, a reduction of 7155 or approximately 18%.
#'
#' \code{company_group} has
#' 31016 unique company names -- 1052 less that \code{company_clean} (roughly a
#' 3% reduction) and 8207 less than \code{sponsor} -- for a total reduction of
#' about 21%.
#'
#' @format A tibble with 225279 rows and 30 fields:
#'
#' \describe{
