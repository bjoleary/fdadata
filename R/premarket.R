...
#' 39059 to 31966, a reduction of 7093 or approximately 18%.
#'
#' \code{company_group} has
#' 30920 unique company names -- 1046 less that \code{company_clean} (roughly a
#' 3% reduction) and 8139 less than \code{sponsor} -- for a total reduction of
#' about 21%.
#'
#' @format A tibble with 224406 rows and 30 fields:
#'
#' \describe{
