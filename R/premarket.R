...
#' 34830 to 32514, a reduction of 2316 or approximately 7%.
#'
#' \code{company_group} has
#' 31462 unique company names -- 1052 less that \code{company_clean} (roughly a
#' 3% reduction) and 3368 less than \code{sponsor} -- for a total reduction of
#' about 10%.
#'
#' @format A tibble with 232405 rows and 30 fields:
#'
#' \describe{
