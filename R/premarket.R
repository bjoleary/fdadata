...
#' 34781 to 32477, a reduction of 2304 or approximately 7%.
#'
#' \code{company_group} has
#' 31426 unique company names -- 1051 less that \code{company_clean} (roughly a
#' 3% reduction) and 3355 less than \code{sponsor} -- for a total reduction of
#' about 10%.
#'
#' @format A tibble with 232139 rows and 30 fields:
#'
#' \describe{
